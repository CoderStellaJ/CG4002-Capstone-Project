...
class UUIDS:
    SERIAL_COMMS = btle.from bluepy import btle
import concurrent
from concurrent import futures
import multiprocessing
import time
...
if __name__ == '__main__':
    # global variables
    beetle_addresses = ["78:DB:2F:BF:3F:63", "78:DB:2F:BF:3B:54", "78:DB:2F:BF:2C:E2"]
    ...
    global_delegate_obj = []
    global_beetle = []
    handshake_flag_dict = {"78:DB:2F:BF:3F:63": True, "78:DB:2F:BF:3B:54": True, "78:DB:2F:BF:2C:E2": True}
    buffer_dict = {"78:DB:2F:BF:3F:63": "", "78:DB:2F:BF:3B:54": "", "78:DB:2F:BF:2C:E2": ""}
    position_buffer = {"78:DB:2F:BF:3F:63": "", "78:DB:2F:BF:3B:54": "", "78:DB:2F:BF:2C:E2": ""}
    incoming_data_flag = {"78:DB:2F:BF:3F:63": False, "78:DB:2F:BF:3B:54": False, "78:DB:2F:BF:2C:E2": False}
    ...
    datastring_dict = {"78:DB:2F:BF:3F:63": "", "78:DB:2F:BF:3B:54": "", "78:DB:2F:BF:2C:E2": ""}
    packet_count_dict = {"78:DB:2F:BF:3F:63": 0, "78:DB:2F:BF:3B:54": 0, "78:DB:2F:BF:2C:E2": 0}
    dataset_count_dict = {"78:DB:2F:BF:3F:63": 0, "78:DB:2F:BF:3B:54": 0, "78:DB:2F:BF:2C:E2": 0}
    float_flag_dict = {"78:DB:2F:BF:3F:63": False, "78:DB:2F:BF:3B:54": False, "78:DB:2F:BF:2C:E2": False}
    timestamp_flag_dict = {"78:DB:2F:BF:3F:63": False, "78:DB:2F:BF:3B:54": False, "78:DB:2F:BF:2C:E2": False}
    comma_count_dict = {"78:DB:2F:BF:3F:63": 0, "78:DB:2F:BF:3B:54": 0, "78:DB:2F:BF:2C:E2": 0}
    checksum_dict = {"78:DB:2F:BF:3F:63": 0, "78:DB:2F:BF:3B:54": 0, "78:DB:2F:BF:2C:E2": 0}
    start_flag = {"78:DB:2F:BF:3F:63": False, "78:DB:2F:BF:3B:54": False, "78:DB:2F:BF:2C:E2": False}
    end_flag = {"78:DB:2F:BF:3F:63": False, "78:DB:2F:BF:3B:54": False, "78:DB:2F:BF:2C:E2": False}
    # clock synchronization global variables
    dance_count = 0
    clocksync_flag_dict = {"78:DB:2F:BF:3F:63": False, "78:DB:2F:BF:3B:54": False, "78:DB:2F:BF:2C:E2": False}
    timestamp_dict = {"78:DB:2F:BF:3F:63": [], "78:DB:2F:BF:3B:54": [], "78:DB:2F:BF:2C:E2": []}
    clock_offset_dict = {"78:DB:2F:BF:3F:63": [], "78:DB:2F:BF:3B:54": [], "78:DB:2F:BF:2C:E2": []}
    ...
    while True:
        ...
        with open(r'dance.txt', 'a') as file:
            ...
            file.write(json.dumps(beetle6_data_dict) + "\n")
            file.close()
...
if __name__ == '__main__':
    ...
    # global variables
    beetle_addresses = ["78:DB:2F:BF:2C:E2"]
    # change this depending on number of decimal places needed; get original float from beetle sensors
    divide_get_float = 100.0
    #beetle_addresses = ["78:DB:2F:BF:3B:54", "78:DB:2F:BF:2C:E2"]
    global_delegate_obj = []
        ...
        for idx in range(0, len(result)):
            for address in result[idx][1].keys():
                if address == "1C:BA:8C:1D:30:22":
                    ...
                    beetle4_data_dict[address] = result[idx][1][address]
                    clean_up_dict(beetle4_data_dict, address)
                elif address == "78:DB:2F:BF:3B:54":
                    beetle5_data_dict[address] = result[idx][1][address]
                    clean_up_dict(beetle5_data_dict, address)
                elif address == "78:DB:2F:BF:2C:E2":
                    beetle6_data_dict[address] = result[idx][1][address]
                    clean_up_dict(beetle6_data_dict, address)
        # clear buffer for next move
        for address in buffer_dict.keys():
            buffer_dict[address] = ""
        print(beetle1_data_dict)
